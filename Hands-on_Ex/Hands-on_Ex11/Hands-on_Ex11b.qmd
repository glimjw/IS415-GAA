---
title: "Hands-on-Exercise 11b: Processing and Visualising Flow Data"
author: "Gerald Lim"
execute:
  warning: false
date: "`r Sys.Date()`"
...
```{r}
#| eval: false
SIM_data <- read_rds("data/rds/SIM_da
```
...
![The code chunk used to calibrate to model is shown below:](images/clipboard-2098303418.png)
