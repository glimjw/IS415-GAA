...
Looking at our filtered_dengue_sf dataset, we can see that there is a long list of repetitive rows of data indicating each onset dates with their specific county, town and village names.

![](images/clipboard-2652456873.png){width="493"}
